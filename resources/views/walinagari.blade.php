                    ...
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            ...
                            <div class="section-title position-relative m-0 font-weight-bold ">
                                ...
                                <h1 class="mt-2">Data Walinagari</h1>
                            </div>
                        </div><!-- /.col -->
                        <div class="col-sm-6 mt-3">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Data Walinagari</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-lg-9 ">
                            ...
                            <div class="card " style="border-radius: 10px;">
                                <div class="card-header d-flex justify-content-center"
                                    ...
                                    <h3 class="card-title  " style="color: #fff; ">Inputkan Data Walinagari</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form role="form" action="{{ route('walinagariupdate') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-10">
                                                <div class="form-group">
                                                    <label for="nama">NAMA WALINAGARI </label>
                                                    <input type="text" class="form-control"
                                                        style="background-color: #fff;" id="nama" name="nama"
                                                        placeholder="Nama Walinagari" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="nip">NIP </label>
                                                    <input type="text" class="form-control"
                                                        style="background-color: #fff;" id="nip" name="nip"
                                                        placeholder="NIP" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="alamat">ALAMAT </label>
                                                    <input type="text" class="form-control"
                                                        style="background-color: #fff;" id="alamat" name="alamat"
                                                        placeholder="Alamat" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="tanggallahir">TANGGAL LAHIR </label>
                                                    <input type="date" class="form-control"
                                                        style="background-color: #fff;" id="tanggallahir" name="tanggallahir" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="riwayatpendidikan">RIWAYAT PENDIDIKAN</label>
                                                    <textarea id="riwayatpendidikan" name="riwayatpendidikan" class="form-control" style="background-color: #fff;" required rows="10" cols="50" placeholder="Riwayat Pendidikan"></textarea>
                                                </div>
                                                
                                                <div class="form-group w-100">
                                                    <label for="image">UPLOAD FOTO WALINAGARI</label>
                                                    <input type="file" class="form-control" style="border-color: #ff0022;" id="image" name="image"
