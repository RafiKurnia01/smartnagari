                    ...
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            ...
                            <div class="section-title position-relative m-0 font-weight-bold ">
                                ...
                                <h1 class="mt-2">Surat Keterangan Tidak Mampu</h1>
                            </div>
                        </div><!-- /.col -->
                    ...
                    <div class="row  d-flex justify-content-center">
                        ...
                        <div class="col-lg-9 ">
                            ...
                            <div class="card " style="border-radius: 10px;">
                                        ...
                                        <div class="row">
                                            <div class="col-md-10">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        style="background-color: #fff;" value="{{ $data->penghasilan }}" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Jumlah Tanggungan</label>
                                                    <input type="text" class="form-control"
                                                        style="background-color: #fff;" value="{{ $data->jumlah_tanggungan }}" readonly>
                                                </div>
                                                
                                                <div class="form-group">
                                                    <label for="alasanMengurusSurat">Keperluan</label>
                                                    <input type="text" class="form-control"
                                                        style="background-color: #fff;" value="{{ $data->keperluan }}" readonly>
                                                </div>
                                                <div class="form-group">
                                ...
                                <form role="form" action="{{ route('update-status') }}" method="POST">
                                    @csrf
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-10">
