      ...
      <div class="card"  style="border-radius: 9px;">
        ...
        <div class="card-body table-responsive p-0 ">
          <table id="example2" class="table table-bordered table-hover">
            <thead style="border-top-right-radius: 10px; border-top-left-radius: 10px; background-color: #ff0022;">
              <tr  style="color: #fff;">
                <th>Nama Anak</th>
                <th>Tanggal Lahir</th>
                <th>Jenis Kelamin</th>
        ...
        <!-- /.card-body -->
          <div class="row my-4 container">
            <div class="col-lg-12 d-flex justify-content-end">
              <button type="button" class="btn "  style=" background-color: #ff0022; border-radius: 9px; width:90px"> <a style="color: #fff;" href="./print-data-balita.html">Print</a> </button>
            </div>
          </div>
          <!-- /.card-body -->
...
<!-- /.content -->
  ...
  <footer class="main-footer d-flex justify-content-center">
    <strong> &copy; 2023 <a href="https://argenesia.com/">Argenesia</a></strong> 
  </footer>
