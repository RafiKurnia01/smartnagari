                        ...
                        <div class="col-lg-9 ">
                            ...
                            <div class="card " style="border-radius: 10px;">
                                <div class="card-header d-flex justify-content-center"
                                    ...
                                    <h3 class="card-title  " style="color: #fff; ">Inputkan Data Wisata</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form role="form" action="{{ route('wisata-post') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-10">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        style="background-color: #fff;" id="tittle" name="tittle"
                                                        placeholder="Judul">
                                                </div>
                                                <div class="form-group">
                                                    <label for="alasanMengurusSurat">Keterangan</label>
                                                    <textarea id="deskripsi" name="deskripsi" class="form-control" style="background-color: #fff;" id="alasanMengurusSurat" placeholder="Detail Produk"
