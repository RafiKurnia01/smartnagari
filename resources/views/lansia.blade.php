                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6 mt-3">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Data Penduduk Lansia</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-lg-9 ">
                            ...
                            <div class="card " style="border-radius: 10px;">
                                <div class="card-header d-flex justify-content-center"
                                    ...
                                    <h3 class="card-title  " style="color: #fff; ">Inputkan Data Penduduk Lansia</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form role="form" action="{{ route('lansiapost') }}" method="POST">
                                    @csrf
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        style="border-color: #ff0022;" id="nama" name="nama" placeholder="Nama" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="nik">NIK</label>
                                                    <input type="text" class="form-control"
                                                        style="border-color: #ff0022;" id="nik" name="nik" placeholder="NIK" required>
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group w-100">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        style="border-color: #ff0022;" id="riwayatpenyakit" name="riwayatpenyakit"
                                                        placeholder="Riwayat Penyakit" required>
                                                </div>
                                                <div class="form-group w-100">
                                                    <label for="alamat">Alamat</label>
                                                    <textarea class="form-control" style="border-color: #ff0022;"
                                                        id="alamat" name="alamat" placeholder="Alamat"></textarea required>
                                                </div>
                                            </div>
                                            <div class="box">
