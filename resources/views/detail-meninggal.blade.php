                    ...
                    <div class="row  d-flex justify-content-center">
                        ...
                        <div class="col-lg-9 ">
                            ...
                            <div class="card " style="border-radius: 10px;">
                                        ...
                                        <div class="row">
                                            <div class="col-md-10">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        style="background-color: #fff;" value="{{ $data->tempatlahir }}" readonly>
                                                </div>
                                                
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Tanggal Lahir</label>
                                                    <input type="text" class="form-control"
                                                        style="background-color: #fff;" value="{{ $data->tanggallahir }}" readonly>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        style="background-color: #fff;" value="{{ $data->tanggalmeninggal }}" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Sebab Meninggal</label>
                                                    <input type="text" class="form-control"
                                                        style="background-color: #fff;" value="{{ $data->sebabmeninggal }}" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label for="alasanMengurusSurat">Nama Pelapor</label>
                                                    <input type="text" class="form-control"
                                                        style="background-color: #fff;" value="{{ $data->namapelapor }}" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label for="alasanMengurusSurat">NIK Pelapor</label>
                                                    <input type="text" class="form-control"
                                                        style="background-color: #fff;" value="{{ $data->nikpelapor }}" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label for="alasanMengurusSurat">Hubungan Pelapor</label>
                                                    <input type="text" class="form-control"
                                                        style="background-color: #fff;" value="{{ $data->hubunganpelapor }}" readonly>
                                                </div>
                                                <div class="form-group">
                                ...
                                <form role="form" action="{{ route('update-status-meninggal') }}" method="POST">
                                    @csrf
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-10">
