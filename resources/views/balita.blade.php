                        ...
                        <div class="col-lg-9 ">
                            ...
                            <div class="card " style="border-radius: 10px;">
                                <div class="card-header d-flex justify-content-center"
                                    ...
                                    <h3 class="card-title  " style="color: #fff; ">Inputkan Data Balita</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form role="form" action="{{ route('balitapost') }}" method="POST">
                                    @csrf
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        style="border-color: #ff0022;" id="umur" name="umur"
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group w-100">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        style="border-color: #ff0022;" id="nama_ibu" name="nama_ibu"                                                        placeholder="Nama Ibu" required>
                                                </div>
                                                <div class="form-group w-100">
                                                    <label for="alamat">Alamat</label>
                                                    <textarea class="form-control" style="border-color: #ff0022;"
                                                        id="alamat" name="alamat" placeholder="Alamat" required></textarea>
                                                </div>
                                            </div>
                                            <div class="box">
                                                <button type="submit" class="btn btn-danger" style="background-color:#ff0022; border-radius: 9px; width: 100px;">Submit</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
