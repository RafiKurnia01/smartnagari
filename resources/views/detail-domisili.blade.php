                    ...
                    <div class="row  d-flex justify-content-center">
                        ...
                        <div class="col-lg-9 ">
                            ...
                            <div class="card " style="border-radius: 10px;">
                                        ...
                                        <div class="row">
                                            <div class="col-md-10">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        style="background-color: #fff;" value="{{ $data->nokk }}" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Alamat Sekarang</label>
                                                    <input type="text" class="form-control"
                                                        style="background-color: #fff;" value="{{ $data->alamatsekarang }}" readonly>
                                                </div>
                                                
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Alamat Pindah</label>
                                                    <input type="text" class="form-control"
                                                        style="background-color: #fff;" value="{{ $data->alamatpindah }}" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Alasan Pindah</label>
                                                    <input type="text" class="form-control"
                                                        style="background-color: #fff;" value="{{ $data->alasanpindah }}" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Tanggal Pindah</label>
                                                    <input type="text" class="form-control"
                                                        style="background-color: #fff;" value="{{ $data->tanggalpindah }}" readonly>
                                                </div>
                                                <div class="form-group">
                                ...
                                <form role="form" action="{{ route('update-status-domisili') }}" method="POST">
                                    @csrf
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-10">
