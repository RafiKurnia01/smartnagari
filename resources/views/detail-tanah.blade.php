                    ...
                    <div class="row  d-flex justify-content-center">
                        ...
                        <div class="col-lg-9 ">
                            ...
                            <div class="card " style="border-radius: 10px;">
                                        ...
                                        <div class="row">
                                            <div class="col-md-10">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        style="background-color: #fff;" value="{{ $data->nomor_sertifikat }}" readonly>
                                                </div>
                                                
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Letak Tanah</label>
                                                    <input type="text" class="form-control"
                                                        style="background-color: #fff;" value="{{ $data->letak_tanah }}" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Luas Tanah</label>
                                                    <input type="text" class="form-control"
                                                        style="background-color: #fff;" value="{{ $data->luas_tanah }}" readonly>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Batas Tanah</label>
                                                    <input type="text" class="form-control"
                                                        style="background-color: #fff;" value="{{ $data->batas_tanah }}" readonly>
                                                </div>
                                                <div class="form-group">
                                ...
                                <form role="form" action="{{ route('update-status-tanah') }}" method="POST">
                                    @csrf
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-10">
