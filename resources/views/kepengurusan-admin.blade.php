                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6 mt-3">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Data Surat Kepengurusan</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-lg-9 ">
                            ...
                            <div class="card " style="border-radius: 10px;">
                                <div class="card-header d-flex justify-content-center"
                                    ...
                                    <h3 class="card-title  " style="color: #fff; ">Inputkan Data Surat Kepengurusan</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form role="form">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group w-100">
                                                    <label for="categorySelect">Jabatan Id </label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        style="background-color: #fff;" id="nik" placeholder="NIK">
                                                </div>
                                               
                                                <div class="form-group">
                                                    <label for="exampleInputDate1">Tanggal Lahir</label>
                                                    <input type="date" class="form-control"
                                                        style="background-color: #fff;" id="exampleInputDate1"
